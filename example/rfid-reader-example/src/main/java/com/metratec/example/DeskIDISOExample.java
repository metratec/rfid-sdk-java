...
/**
 * Example class demonstrating DeskID ISO HF RFID reader functionality.
 * 
 * This class provides automated demos for: - USB connection (default) - Inventory operations for ISO 15693 tags -
 * Block-based read/write operations - HF tag information display and management
 */
public class DeskIDISOExample {


    /**
     * Demonstrate HF inventory operations
     */
    public void performInventoryExample() {
        ...
        DeskID_ISO reader = new DeskID_ISO("DeskID-ISO-USB", serialPort, 115200, 8, 1, 0, 0);
        ...
        try {
            // Connect
            System.out.println("Connecting to DeskID ISO reader...");
            ...
            try {
                reader.stop();
                System.out.println("Disconnected from DeskID ISO reader.");
            } catch (Exception e) {
    ...
    /**
     * Demonstrate HF read/write operations
     */
    ...
    public static void main(String[] args) {
        System.out.println("=== DeskID ISO Example ===");
        DeskIDISOExample example = new DeskIDISOExample();
