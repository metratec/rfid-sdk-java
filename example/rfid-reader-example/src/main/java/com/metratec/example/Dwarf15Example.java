...
/**
 * Example class demonstrating Dwarf15 HF SMD Module RFID reader functionality.
 * 
 * The Dwarf15 is one of the smallest HF RFID modules in the world for direct SMD soldering. It supports multiple
 * connectivity options including USB, TCP/Ethernet, and RS232 Serial.
 * 
 * This class provides automated demos for: - USB connection (default) - TCP/Ethernet connection (alternative) -
 * Inventory operations for ISO 15693 tags - Block-based read/write operations - Compact module integration features
 */
public class Dwarf15Example {

    /**
     * Demonstrate Dwarf15 inventory operations using USB connection
     */
    public void performInventoryExample() {
        ...
        Dwarf15 reader = new Dwarf15("Dwarf15", serialPort, 115200, 8, 1, 0, 0);
        // Alternatively if the reader should be connected with tcp:
        // Dwarf15 reader = new Dwarf15("Dwarf15", "192.168.2.239", 10001);
        ...
        try {
            // Connect
            System.out.println("Connecting to Dwarf15...");
            ...
            try {
                reader.stop();
                System.out.println("Disconnected from Dwarf15 module.");
            } catch (Exception e) {
    ...
    /**
     * Demonstrate Dwarf15 read/write operations
     */
    ...
    public static void main(String[] args) {
        System.out.println("=== Dwarf15 Example ===");
        Dwarf15Example example = new Dwarf15Example();
