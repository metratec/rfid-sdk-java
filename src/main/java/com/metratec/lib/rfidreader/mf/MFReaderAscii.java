 ...
 * 
 */
public class MFReaderAscii extends MetratecReaderAscii<MfTag> {
  /** Card type mifare 1k */
   ...
   */
  protected MFReaderAscii(String identifier, ICommConnection connection, String... minReaderRevision) {
   ...
   */
  @Deprecated
  public MFReaderAscii(String identifier, String usbDeviceSerialNumber) {
   ...
   */
  @Deprecated
  public MFReaderAscii(String identifier, String ipAddress, int port) {
   ...
   */
  @Deprecated
  public MFReaderAscii(String identifier, String portName, int baudrate, int dataBit, int stopBit,
  ...
  /**
   * Use {@link MFReaderAscii#stop()} for close the connection
   * 
...
//        }
   ...
   */
  public void startInventory(long tagLostTime, boolean onlyNewTags)
      throws CommConnectionException, RFIDReaderException {
    if (scanningForTags) {
  ...
  public void startInventory(long tagLostTime) throws CommConnectionException, RFIDReaderException {
    startInventory(tagLostTime, false);
  }
