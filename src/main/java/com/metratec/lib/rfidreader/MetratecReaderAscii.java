...
/**
 * Abstract base class for Metratec RFID readers that use the ASCII protocol.
 * This class extends MetratecReader and provides specific functionality for readers
 * that communicate using ASCII-based commands and responses. It handles protocol-specific
 * features like CRC checking, EOF handling, and antenna port management.
 * 
 * @param <T> the type of RFID tag handled by this reader
 * @author Matthias Neumann (neumann@metratec.com)
 * 
 */
public abstract class MetratecReaderAscii<T extends RfidTag> extends MetratecReader<T> {
   ...
   */
  public MetratecReaderAscii(String identifier, ICommConnection connection) {
   ...
   * @throws RFIDReaderException if an reader exception occurs
   */
  public String[] executeCommand(String command, Object... parameters) throws CommConnectionException, RFIDReaderException {
  ...
  @Override
  public void setHeartbeatInterval(int interval) throws RFIDReaderException, CommConnectionException {
    if (interval > 0) {
