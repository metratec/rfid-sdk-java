 ...
 * 
 */
public class UHFReaderAscii extends MetratecReaderAscii<UhfTag> {

  private static Logger logger = LoggerFactory.getLogger(UHFReaderAscii.class);
  /** fifo length error */
   ...
   */
  protected UHFReaderAscii(String identifier, ICommConnection connection, String... minReaderRevision) {
   ...
   * @param minReaderRevision minimal reader revision
   */
  protected UHFReaderAscii(String identifier, ICommConnection connection, READER_MODE mode,
  ...
  /**
   * Use {@link UHFReaderAscii#stop()} for close the connection
   * 
   ...
   * {@link UHFReaderAscii#enableStartUpCommands()}.
   * 
   * @param commands list with commands to execute (ASCII protocol commands)
   * @throws CommConnectionException if an communication exception occurs
   * @throws RFIDReaderException if an protocol exception occurs (e.g. CRC error, value out of
