 ...
 *
 */
public class DwarfG2Mini extends UHFReaderAscii {
  /**
   ...
   */
  public DwarfG2Mini(String identifier, ICommConnection connection, UHFReaderAscii.READER_MODE mode) {
   ...
   * @param mode the used RFID communication standart. ({@link UHFReaderAscii READER_MODE})
   */
  public DwarfG2Mini(String identifier, String usbDeviceSerialNumber, UHFReaderAscii.READER_MODE mode) {
   ...
   * @param mode the used RFID communication standart. ({@link UHFReaderAscii READER_MODE})
   */
  public DwarfG2Mini(String identifier, String ipAddress, int port, UHFReaderAscii.READER_MODE mode) {
